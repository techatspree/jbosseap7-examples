 ...
 */
package de.akquinet.jbosscc.examples.eap.websockets;

import de.akquinet.jbosscc.examples.eap.websockets.model.Bid;
import de.akquinet.jbosscc.examples.eap.websockets.model.Bidding;
import de.akquinet.jbosscc.examples.eap.websockets.model.BiddingFactory;
 ...
 */
@Stateless
@ServerEndpoint(value = "/websockets/bidsocket", encoders = {BiddingEncoder.class}, decoders = {MessageDecoder.class})
public class BidWebSocketEndpoint {
    ...
    public void startIntervalNotifier() {
        ...
        threadFactory.newThread(intervalNotifier).start();
